...
- Download processed audio as WAV or MP3
...
The app supports MP3 upload and MP3 export using `pydub`.

For Streamlit Cloud deployment, keep this file in the repository root:
...
This helps the deployed app decode and export MP3 files correctly. Locally, MP3 support also requires FFmpeg to be installed on your computer. WAV will still work without MP3 export.
